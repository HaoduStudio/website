...
比如，我的 `APK文件` 储存在 `F:\FlashTools\DailyNotes.apk` 下，则需要输入以下命令：

```
adb install -r F:\FlashTools\DailyNotes.apk
```

> 当然，您也可以借助第三方工具箱完成安装操作。我也不知道为什么要加命令行安装方式，也许有些人懒得装第三方软件吧。
